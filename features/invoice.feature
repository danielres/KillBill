Feature: Generate an invoice with activvities and totals
  ...
  Scenario: A user reads how much he is charged, without and with VAT
    Given an invoice "2013012" with VAT: 21%, hourly rate: 56
    And   an activity "yawning" counting 2 hours for the invoice "2013012"
    And   an activity "snoring" counting 3.1 hours for the invoice "2013012"
    Then  the total charged for invoice "2013012" without taxes should be 285.60
    And   the taxes for invoice "2013012" should be 59.98
    And   the total charged for invoice "2013012" with taxes should be 345.58
